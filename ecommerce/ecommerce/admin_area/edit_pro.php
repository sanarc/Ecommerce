...
if(isset($_GET['edit_pro'])){
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$get_cat = "select * from categories where category_id='$pro_category'";
...
<body bgcolor="skyblue">
	...
	echo "<option value='$brand_id'>$brand_title</option>";
			...
			<tr>
				...
				<td><textarea name="product_description" cols="20" rows="10"><?php echo $pro_description;?></textarea></td>
			</tr>
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "update products set product_category='$product_category',product_brand='$product_brand',product_title='$product_title',product_price='$product_price',product_description='$product_description',product_image='$product_image', product_keywords='$product_keywords' where product_id='$update_id'";
